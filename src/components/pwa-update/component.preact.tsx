...
export function PwaUpdatePrompt(): JSX.Element | null {
	...
	return (
		...
		>
			<p style={{ margin: 0, fontWeight: 600 }}>{needRefresh ? 'Neue Version verfügbar!' : 'App bereit für Offline-Nutzung'}</p>
			{needRefresh && <p style={{ margin: 0, fontSize: '13px', color: '#595959' }}>Jetzt aktualisieren, um die neueste Version zu laden.</p>}
